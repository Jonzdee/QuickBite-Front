        ...
        <div className="flex-grow flex flex-wrap md:pl-20 mt-10 md:mt-0 text-center md:text-left">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/cuisine/pizza" className="hover:text-orange-400">Pizza</Link></li>
              <li><Link to="/cuisine/burgers" className="hover:text-orange-400">Burgers</Link></li>
              <li><Link to="/cuisine/sushi" className="hover:text-orange-400">Sushi</Link></li>
              <li><Link to="/cuisine/african" className="hover:text-orange-400">African Dishes</Link></li>
            </ul>
          </div>
