...
export default function Navbar() {
  return (
    <Disclosure
      as="nav"
      className="relative bg-transparent py-4 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10"
    >
                ...
                {navigation.map((item) => (
                  <Link
                    ...
                    className={classNames(
                      item.current ? 'bg-orange-400 text-white' : 'text-gray-500 hover:bg-orange-400 hover:text-white',
